...
class Transfer(Account):
    ...
    async def bridge_logic(self, source_chain, destination_chain, amount_wei, amount, balance, slippage=0.1):
    ...
    async def transfer_eth(
            ...
            min_required_amount: float, destination_chain: str = 'goerli',
            bridge_from_all_chains: bool = False, sleep_between_transfers=None, slippage=5):
        ...
        for source_chain in source_chains:
            ...
            await self.bridge_logic(source_chain, destination_chain, amount_wei, amount, balance, slippage)
